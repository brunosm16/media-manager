export const MEDIA_MANAGER_PARENT_QUEUE = 'media-manager-jobs-parent-queue';
export const RESCALE_IMAGE_JOB = 'rescale-image-queue';
export const RESCALE_DIRECTORY = 'rescaled';
